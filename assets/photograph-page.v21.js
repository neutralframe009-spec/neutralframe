(() => {
  ...
  //
  //   NNN  : 3-digit article number (001-999) — shown as FIG. NNN
  //   FF   : 2-digit figure number within the page (01-99) — reserved for multi-photo pages
  ...
  const applyMeta = (root, meta) => {
    ...
    setText('[data-photo-fig]',       meta.no,    root);
  ...
  document.querySelectorAll('[data-photo-file]').forEach((fig) => {
    ...
    const metaRoot = fig.closest('.p2-wrap') || fig;
    applyMeta(metaRoot, meta);
  });
